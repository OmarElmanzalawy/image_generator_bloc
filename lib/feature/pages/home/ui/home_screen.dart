  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text.rich(
          TextSpan(text: 'Image',style: TextStyle(fontWeight: FontWeight.w300,fontSize: 30),
          children: [
            TextSpan(
              text: 'AI',
      ...
      body: Stack(
        ...
        Padding(
          ...
          child: Column(
            ...
            Text("Generated Images: ",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w300),),
            // const SizedBox(height: 5,),
            Padding(
              padding: EdgeInsets.only(bottom: size.height * 0.018),
              child: Text('These are AI images generated by other users',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w300,color: Colors.white60),),
            ),
            Expanded(
              child: BlocBuilder(
                bloc: homeBloc,
