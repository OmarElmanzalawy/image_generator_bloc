  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<BackgroundrRemovalBloc, BackgroundrRemovalState>(
        bloc: bloc,
        listenWhen:
            (previous, current) => current is BackgroundrRemovalActionState,
        buildWhen:
            (previous, current) => current is! BackgroundrRemovalActionState,
        listener: (context, state) {
          if (state is BackgroundRemovalImageGenerateFailureActionState) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                backgroundColor: Colors.black12,
                content: Text(
                  "Error happened while generating image",
        ...
        builder: (context, state) {
          return AnimatedSwitcher(
            ...
            child:
                state is BackgroundRemovalImageGeneratedSuccessState
                    ? ImageResultWidget(image: state.imagePath)
                    : Stack(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AnimatedSwitcher(
                                ...
                                child:
                                    state is BackgroundRemovalLoadingState
                                        ? LoadingWidget()
                                        : Column(
                                          crossAxisAlignment:
                                          ...
                                          children: [
                                            ...
                                            AnimatedSwitcher(
                                              ...
                                              child:
                                                  state
                                                              is BackgroundRemovalPictureSelected &&
                                                      ...
                                                      : UploadImageCard(
                                                        ...
                                                        ontap: () {
                                                          bloc.add(
                                                            BackgroudRemovalImageSelectionEvent(),
                                                          );
                                                        },
                                                      ),
                                            ),
                                              ...
                                              child: IconActionButton(
                                                onpressed: () {
                                                  if (state
                                                    ...
                                                    final image =
                                                        state
                                                            as BackgroundRemovalPictureSelected;
                                                    bloc.add(
                                                      BackgroundRemovalSubmitButtonClickEvent(
